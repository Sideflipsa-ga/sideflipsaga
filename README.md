...
<!--A paragraph -->
<p>We post pretty much <em>what ever</em> we want <em>when ever</em> we want</p>
<!--A paragraph with emphasis on some words -->
<p>Our GitHub</p>
...
<!--A link -->
    <p> Also, here is my Richman Sword I made Command <code>/give @p golden_sword{Unbreakable:1,Enchantments:[{id:sweeping,lvl:9999},{id:knockback,lvl:9999},{id:fire_aspect,lvl:9999},{id:mending,lvl:9999},{id:sharpness,lvl:9999},{id:looting,lvl:9999}]}</code>
  -Side </p>
   <!--the code element makes things look like code -->
